/*
cgo stubs for package golanghello.
...
// --- generated code for package: golanghello below: ---
...
//export golanghello_AddNumbers
func golanghello_AddNumbers(a C.longlong, b C.longlong) C.longlong {
	_saved_thread := C.PyEval_SaveThread()
	defer C.PyEval_RestoreThread(_saved_thread)
	return C.longlong(golanghello.AddNumbers(int(a), int(b)))

}

//export golanghello_SayHello
func golanghello_SayHello(name *C.char) *C.char {
	_saved_thread := C.PyEval_SaveThread()
	defer C.PyEval_RestoreThread(_saved_thread)
	return C.CString(golanghello.SayHello(C.GoString(name)))
