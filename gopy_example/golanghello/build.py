# python build stubs for package golanghello
...
mod = Module('_golanghello')
mod.add_include('"golanghello_go.h"')
...
add_checked_function(mod, 'golanghello_AddNumbers', retval('int64_t'), [param('int64_t', 'a'), param('int64_t', 'b')])
add_checked_string_function(mod, 'golanghello_SayHello', retval('char*'), [param('char*', 'name')])

mod.generate(open('golanghello.c', 'w'))
